    ...
    <div class="relative py-12 bg-white">
        <div class="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
            <div class="lg:text-center">
                ...
                <p class="mt-2 text-3xl font-extrabold leading-8 tracking-tight text-gray-900 sm:text-4xl">A better way
                    to send money</p>
                <p class="max-w-2xl mt-4 text-xl text-gray-500 lg:mx-auto">Lorem ipsum dolor sit amet consect
