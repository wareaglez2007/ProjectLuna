<div x-data="{ open: false }" @keydown.window.escape="open = false" class="bg-white">
    ...
    <div x-show="open" class="fixed inset-0 flex z-40 lg:hidden"
        ...
        <div x-show="open" x-transition:enter="transition-opacity ease-linear duration-300"
            ...
            class="fixed inset-0 bg-black bg-opacity-25" @click="open = false" aria-hidden="true" style="display: none;">
        </div>
            ...
            <div class="border-b border-gray-200">
                <div class="h-16 flex items-center">
                    <button type="button" x-description="Mobile menu toggle, controls the 'mobileMenuOpen' state."
                        class="bg-white p-2 rounded-md text-gray-400 lg:hidden" @click="open = true">
                        ...
                        <div class="h-full flex space-x-8">
                            ...
                            <div class="flex" x-data="{ open: false, focus: false }" x-init="init()">
                                ...
                                <div x-show="open" x-transition:enter="transition ease-out duration-200"
                                    ...
                                    class="absolute top-full inset-x-0 text-sm text-gray-500" x-ref="panel"
